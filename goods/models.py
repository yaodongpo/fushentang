...
class GoodsType(BaseModel):
    ...
    image = models.ImageField(upload_to='type/%Y/%m/%d/', verbose_name='商品类型图片')
...
class GoodsImage(BaseModel):
    ...
    image = models.ImageField(upload_to='goods/%Y/%m/%d/', verbose_name='图片路径')
...
class IndexPromotionBanner(BaseModel):
    ...
    image = models.ImageField(upload_to='banner/%Y/%m/%d/', verbose_name='活动图片')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
